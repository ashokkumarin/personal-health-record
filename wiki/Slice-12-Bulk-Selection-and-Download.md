...
Implements Story 12 ([MVP Spec](MVP-Spec)). Depends on Slice 11's single-record download helper on mobile and the signed-download-URL flow on web — this slice is the multi-record wrapper around both.
