...
See [API reference → Files](API-Reference#files) and
[Backend service → Signed URLs](Backend-Service#signed-file-urls).
...
[Data model → Authorization model](Data-Model#authorization-model) for
the full rule set.
