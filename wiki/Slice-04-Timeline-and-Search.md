...
Implements [Requirements and Project Plan](Requirements-and-Project-Plan) Sections 6.5 (Timeline View) and 6.7 (Search) via one endpoint — filters double as both features, matching [MVP Spec](MVP-Spec)'s Story 5 and Section 4.6.
...
- Mobile filters/search UI — mobile's timeline screen is list-only this slice (see [Technical Design](Technical-Design)).
