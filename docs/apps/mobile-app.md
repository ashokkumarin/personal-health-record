...
[Deployment](../deployment.md#environment-variables) for the full variable list.
...
[Deployment → dependency hoisting](../deployment.md#dependency-hoisting-across-two-major-react-versions)
