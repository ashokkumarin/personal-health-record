...
Implements [Requirements and Project Plan](Requirements-and-Project-Plan) Section 6.6 as a single toggle rather than a separate request/grant workflow (user's choice — see [Technical Design](Technical-Design)).
...
- AuditLog — not tied to a concrete acceptance criterion in [MVP Spec](MVP-Spec); deferred.
