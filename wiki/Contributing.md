...
- For anything beyond a small fix, open an issue first to discuss the
  ...
  [Feature Slices](Feature-Slices)) — larger features should get a short slice doc describing
  the user story and acceptance criteria before implementation starts.
- Check existing issues/PRs to avoid duplicate work.

## Development setup

See [Getting Started](Getting-Started) for the full local setup
...
public issue — see [Security Policy](Security-Policy) instead.
...
the project's [AGPL-3.0-or-later license](https://github.com/ashokkumarin/personal-health-record/blob/main/LICENSE).
