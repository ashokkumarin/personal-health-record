...
> **Status: Delivered as MVP v1.0.** This document is the original discovery/planning doc and is kept as-is for historical context. For the as-built spec, data model, and delivery history, see [MVP Spec](MVP-Spec) and [Technical Design](Technical-Design); for the current setup/feature list see [Home](Home).
